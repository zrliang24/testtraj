...
Before you begin, make sure that the package folder contains the **hyts_std** executable file. Check that the file has permissions to run as an executable. On Linux, find **hyts_std** and copy it into the package folder. Click on the Permissions tab and check the box to "Allow executing file as program."
...
-   Binary path error:
    -   Check that libgfortran.so.3 is installed.
