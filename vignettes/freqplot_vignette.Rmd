...
Add a date in 'YYYY-MM-DD' character format for the trajDate parameter. Next, configure the directories:
...
* Set the ExecDir, or executive directory, to the folder that has the **hyts_std** file. 
